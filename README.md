About hpp-practicals-feedstock
==============================
...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/hpp-practicals-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/hpp-practicals-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add hpp-practicals
# for installing globally
pixi global install hpp-practicals
```
...
It is possible to list all of the versions of `hpp-practicals` available on your platform:
...
```
pixi search hpp-practicals --channel conda-forge
```
